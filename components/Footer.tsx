...
export default function Footer() {
  return (
    <footer className="text-muted-foreground border-t border-border py-10 mt-20">
      <div className="container mx-auto px-4 flex flex-col  items-center justify-between gap-6">
        ...
        <div className="flex flex-row items-center gap-6">
          ...
          {/* Grupo personal */}
          <div className="flex gap-5 items-center">
            <Link href="https://wa.me/3016957368" target="_blank" aria-label="WhatsApp" className="transition-colors duration-300 group">
              <svg
                viewBox="0 0 24 24"
                className="w-6 h-6 md:fill-current md:group-hover:fill-[#25D366] fill-[#25D366] transition-colors duration-400 group"
            ...
            <Link href="https://www.instagram.com/amilcar.ibarra02/" target="_blank" aria-label="Instagram" className="transition-colors duration-300 group">
              <svg
                viewBox="0 0 24 24"
                className="w-6 h-6 md:fill-current md:group-hover:fill-[#FF0069] fill-[#FF0069] transition-colors duration-400 group"
                xmlns="http://www.w3.org/2000/svg"
              >
            ...
            <Link href="https://www.facebook.com/amilkar.ibarra" target="_blank" aria-label="Facebook" className="transition-colors duration-300 group">
              <svg
                viewBox="0 0 24 24"
                className="w-6 h-6 md:fill-current md:group-hover:fill-[#1877F2] fill-[#1877F2] transition-colors duration-400 group"
                xmlns="http://www.w3.org/2000/svg"
              >
